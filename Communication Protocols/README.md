The present scenario uses classical networking protocols such as DSRC/WAVE.The traversal algorithms are implemented on top of the dedicated short-range 
